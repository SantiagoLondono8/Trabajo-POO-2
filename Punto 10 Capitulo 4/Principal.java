...
public class Principal extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(txtEstrato, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        // TODO add your handling code here:
        double patrimonio, estrato, precio;
        String nombre, codigo;
        estrato = Double.parseDouble(txtEstrato.getText());
        patrimonio = Double.parseDouble(txtPatrimonio.getText());
        nombre = txtNombre.getText();
        codigo = txtNumero.getText();
        precio = 50000;
        if (patrimonio > 2000000 && estrato > 3) {
            precio = precio + 0.03 * patrimonio;
        }
        JOptionPane.showMessageDialog(this, "El estudiante con numero de inscripcion " + codigo + " y nombre " + nombre + " debe pagar: " + precio);
